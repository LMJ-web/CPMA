...
layui.config({
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">请叫我学长</div>'+
							'<div class="input_btn">'+
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['确认'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>欢迎使用后台管理系统！现在暂时没有系统公告。</p></div>',
